...
![formula](https://render.githubusercontent.com/render/math?math=Q(s_t,a_t)=Q(s_t,a_t)+ \eta\times(R_{t+1}+\gamma Q(s_{t+1},a_{t+1})-Q(s_t,a_t)))
</div>
Q-Learnig的更新公式為
<div align=center>

![formula2](https://render.githubusercontent.com/render/math?math=Q(s_t,a_t)=Q(s_t,a_t)+ \eta\times(R_{t+1}+\gamma \underset{a}{\max} (Q(s_{t+1},a)-Q(s_t,a_t)))
</div>
